---
canonical_url: "https://docs.codinit.dev/essentials/ai-chat-commands"
...
CodinIT's AI-powered chat interface is your intelligent coding assistant, capable of understanding natural language requests and generating production-ready code across 19+ AI providers.
...
<Tabs>
  ...
  <Tab title="UI Button" icon="mouse-pointer">
    Click the **AI Chat** icon in the sidebar or bottom panel
  </Tab>
  <Tab title="Command Palette" icon="terminal">
    Open Command Palette (`Cmd/Ctrl + Shift + P`) and type "Open AI Chat"
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="Claude (Anthropic)" icon="/assets/ai-icons/anthropic.svg">
    **Best for:**
  ...
  <Tab title="GPT-4 (OpenAI)" icon="/assets/ai-icons/openai.svg">
    **Best for:**
  ...
  <Tab title="Local Models (Ollama)" icon="/assets/ai-icons/ollama.svg">
    **Best for:**
...
<CardGroup cols={2}>
  <Card title="Iterate Gradually" icon="arrows-rotate">
    Build features incrementally. Start simple, then ask AI to enhance.
  </Card>

  <Card title="Review AI Code" icon="magnifying-glass">
...
<CardGroup cols={2}>
  <Card title="Prompt Engineering Guide" icon="wand-magic-sparkles" href="/prompting/prompt-engineering-guide">
  ...
  <Card title="Project Templates" icon="folder-tree" href="/essentials/project-templates">

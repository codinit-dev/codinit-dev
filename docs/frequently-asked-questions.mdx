---
canonical_url: "https://docs.codinit.dev/frequently-asked-questions"
...
<Card title="Need Immediate Help?" icon="question-circle" horizontal href="#get-help--support">
...
<AccordionGroup>
  <Accordion title="What are the best models for CodinIT.dev?" icon="circle-question" iconType="brands">
  ...
  <Accordion title="How do I configure API keys for different providers?" icon="key">
    You can configure API keys in two ways:

    **Option 1: Environment Variables (Recommended for production)** Create a `.env.local` file in your project root:
  ...
  <Accordion title="How do I add a new LLM provider?" icon="plug">
    CodinIT.dev uses a modular provider architecture. To add a new provider:

    1. **Create a Provider Class** in `app/lib/modules/llm/ai-icons/your-provider.ts`
    ...
    See the provider implementation examples in the codebase for complete details.
  </Accordion>
  <Accordion title="How do I set up Moonshot AI (Kimi) provider?" icon="star">
  ...
  <Accordion title="What are the latest xAI Grok models?" icon="zap">
...
<AccordionGroup>
  <Accordion title="How do I access help and documentation?" icon="question-circle">
  ...
  <Accordion title="How do I get the best results with CodinIT.dev?" icon="sparkles">
    ...
    **Development Workflow:**
    ...
    - **Batch simple instructions**: Combine tasks like _"Change colors, add mobile responsiveness, restart dev server"_
  ...
  <Accordion title="How do I use MCP (Model Context Protocol) tools?" icon="puzzle-piece">
  ...
  <Accordion title="How do I deploy my CodinIT.dev projects?" icon="rocket">
  ...
  <Accordion title="How do I use Git integration features?" icon="git-branch">
...
<AccordionGroup>
  <Accordion title="How do I contribute to CodinIT.dev?" icon="users">
    Check out our GitHub repository for contribution guidelines and get involved with the community!
  </Accordion>
  <Accordion title="What are the future plans for CodinIT.dev?" icon="road">
    Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates. New features and improvements are on the way!
  </Accordion>
  <Accordion title="Why are there so many open issues/pull requests?" icon="comments">
...
<AccordionGroup>
  <Accordion title="What's new in CodinIT.dev?" icon="newspaper">
  ...
  <Accordion title="How do I use the new project templates?" icon="template">
  ...
  <Accordion title="How does WebContainer work?" icon="container">
  ...
  <Accordion title="How do I connect external databases?" icon="database">
...
<AccordionGroup>
  <Accordion title="How do local LLMs compare to larger models like Claude 3.5 Sonnet for CodinIT.dev?" icon="scale">
...
<AccordionGroup>
  <Accordion title="There was an error processing this request" icon="exclamation-triangle">
  ...
  <Accordion title="x-api-key header missing" icon="key">
  ...
  <Accordion title="Blank preview when running the app" icon="eye-slash">
  ...
  <Accordion title="MCP server connection failed" icon="unplug">
  ...
  <Accordion title="Git integration not working" icon="git-branch">
  ...
  <Accordion title="Deployment failed" icon="rocket">
  ...
  <Accordion title="Everything works, but the results are bad" icon="thumbs-down">
  ...
  <Accordion title="WebContainer preview not loading" icon="display">
  ...
  <Accordion title="Received structured exception #0xc0000005: access violation" icon="/assets/frameworks/icons/windows.svg">
  ...
  <Accordion title="Miniflare or Wrangler errors in Windows" icon="laptop">
  ...
  <Accordion title="Provider not showing up after adding it" icon="plug">
...
<CardGroup cols={2}>
  ...
  <Card title="Desktop Version Issues" icon="desktop">

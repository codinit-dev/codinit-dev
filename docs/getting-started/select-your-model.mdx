---
canonical_url: "https://docs.codinit.dev/getting-started/select-your-model"
...
<img
  ...
  light="/assets/images/model-selector-light.png"
  dark="/assets/images/model-selector-dark.png"
  alt="Model Selector"
/>
...
<Card title="Deep Dive: AI Providers" icon="graduation-cap" href="/providers/provider-guide">

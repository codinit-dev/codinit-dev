---
canonical_url: "https://docs.codinit.dev/providers/openrouter"
title: "OpenRouter"
description: "Learn how to use OpenRouter with Codinit to access a wide variety of language models through a single API."
---

OpenRouter is an AI platform that provides access to a wide variety of language models from different providers, all through a single API.

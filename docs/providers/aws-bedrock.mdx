---
canonical_url: "https://docs.codinit.dev/providers/aws-bedrock"
title: Amazon Bedrock
description: Configure Amazon Bedrock in CodinIT to build your apps with bedrocks AI models.
---

The Amazon Bedrock provider contains language model support for the [Amazon Bedrock](https://aws.amazon.com/bedrock) APIs.
...
See AI SDK UI Chatbot documentation for more details

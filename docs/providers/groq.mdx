---
canonical_url: "https://docs.codinit.dev/providers/groq"
title: "Groq"
description: "Learn how to configure and use Groq's lightning-fast inference with CodinIT."
---

Groq provides ultra-fast AI inference through their custom LPU™ (Language Processing Unit) architecture, purpose-built for inference rather than adapted from training hardware.

---
canonical_url: "https://docs.codinit.dev/providers/openai"
title: "OpenAI"
...
-   'gpt-4.1'
-   'gpt-4.1-mini'
-   'gpt-5' (great for all round tasks)
...
1.  **Open Settings:** Click the settings gear icon (⚙️) on the sidebar panel.

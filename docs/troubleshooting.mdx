---
canonical_url: "https://docs.codinit.dev/troubleshooting"
...
<AccordionGroup>
  <Accordion icon="key" title="Invalid API key errors">
    ...
    **Provider-specific tips**:
    ...
    <Warning>Never share your API keys publicly or commit them to version control.</Warning>
  </Accordion>

  <Accordion icon="credit-card" title="Rate limit exceeded">
    ...
    **Solutions**:
    ...
    <Tip>Set up multiple providers as fallbacks to avoid workflow interruption.</Tip>
  </Accordion>

  <Accordion icon="exclamation-triangle" title="Provider connection failures">
    ...
    **Solutions**:
    ...
    <Info>Network issues typically resolve themselves - try again in a few minutes.</Info>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="play" title="CodinIT won't launch">
  ...
  <Accordion icon="window" title="Web version not loading">
    ...
    **Solutions**:
    ...
    <Note>The web version requires modern browser features - update if experiencing issues.</Note>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="terminal" title="Terminal not working">
    ...
    **Solutions**:
    ...
    <Tip>Use an external terminal if the built-in terminal continues to have issues.</Tip>
  </Accordion>

  <Accordion icon="folder" title="File operations failing">
    ...
    **Solutions**:
    ...
    <Warning>Large files or many simultaneous operations can cause performance issues.</Warning>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="gauge" title="Application running slowly">
  ...
  <Accordion icon="zap" title="AI responses are slow">
    **Problem**: AI completions and chat responses take too long.

    **Solutions**:
    1. **Choose faster providers**: Use Groq or GPT-4o-mini for quick responses
    ...
    <Info>Provider speed varies - test different providers to find the fastest for your needs.</Info>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion icon="cpu" title="High CPU usage">
    ...
    **Solutions**:
    ...
    <Tip>High CPU usage is normal during intensive AI operations or when running Docker containers.</Tip>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="github" title="Git operations failing">
  ...
  <Accordion icon="sync" title="Sync issues with remote">
    ...
    **Solutions**:
    ...
    <Warning>Force pushing can overwrite others' work - use with extreme caution.</Warning>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="rocket" title="Deployment failures">
  ...
  <Accordion icon="database" title="Supabase connection issues">
    ...
    **Solutions**:
    ...
    <Tip>Use Supabase dashboard to test queries directly if connection fails in CodinIT.</Tip>
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github">
    Check [existing issues](https://github.com/codinit/issues) or create new ones for bugs and features.
  </Card>
  <Card title="Discord Community" icon="discord">
    Join our [Discord server](https://discord.gg/codinit) for real-time help and discussions.
  </Card>
  <Card title="Stack Overflow" icon="stack-overflow">
    Ask questions with the [codinit tag](https://stackoverflow.com/questions/tagged/codinit) on Stack Overflow.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Contact us">
    ...
    - **Discord**: Ask in our help channel
  </Step>
</Steps>

---
canonical_url: "https://docs.codinit.dev/running-models-locally/local-model-setup"
title: "Guide"
...
Run CodinIT completely offline with genuinely capable models on your own hardware. No API costs, no data leaving your machine, no internet dependency.

Local models have reached a turning point where they're now practical for real development work. This guide covers everything you need to know about running CodinIT with local models.
...
| 64GB | Qwen3 Coder 30B | 8-bit | Full CodinIT features |
...
After extensive testing, **Qwen3 Coder 30B** is the most reliable model under 70B parameters for CodinIT:
...
- **Proven reliability** - Consistent outputs with CodinIT's tool format
...
Most models under 30B parameters (7B-20B) fail with CodinIT because they:
...
- Switch to bash in CodinIT Settings → Terminal → Default Terminal Profile
...
- **Discord**: [Join our community](https://discord.gg/codinit) for real-time help
- **Reddit**: [r/codinit](https://www.reddit.com/r/codinit/) for discussions
...
<CardGroup cols={2}>
  ...
  <Card title="Ollama Setup" icon="terminal" href="/providers/ollama">
...
Local models with CodinIT are now genuinely practical. While they won't match top-tier cloud APIs in speed, they offer complete privacy, zero costs, and offline capability. With proper configuration and the right hardware, Qwen3 Coder 30B can handle most coding tasks effectively.

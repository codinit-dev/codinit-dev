...
describe("StreamingMessageParser", () => {
  ...
  describe("no artifacts", () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ["Foo bar <p", "Foo bar <p"],
      [
        ["Foo bar <", "s", "p", "an>some text</span>"],
        "Foo bar <span>some text</span>",
      ],
    ])(
      "should correctly parse chunks and strip out codinit artifacts (%#)",
      (input, expected) => {
  ...
  describe("invalid or incomplete artifacts", () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      [
        "Foo bar <codinitArtifacs></codinitArtifact>",
        "Foo bar <codinitArtifacs></codinitArtifact>",
      ],
      [
        "Before <oltArtfiact>foo</codinitArtifact> After",
        "Before <oltArtfiact>foo</codinitArtifact> After",
      ],
      [
        "Before <codinitArtifactt>foo</codinitArtifact> After",
        "Before <codinitArtifactt>foo</codinitArtifact> After",
      ],
    ])(
      "should correctly parse chunks and strip out codinit artifacts (%#)",
...
function runTest(
  input: string | string[],
  outputOrExpectedResult: string | ExpectedResult,
) {

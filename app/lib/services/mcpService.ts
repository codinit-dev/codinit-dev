...
import {
  ...
  type MCPConfig,
  type MCPServerAvailable as ClientMCPServerAvailable,
  type MCPServerUnavailable as ClientMCPServerUnavailable,
  type MCPServerConnecting as ClientMCPServerConnecting,
} from '~/types/mcp';

const logger = createScopedLogger('mcp-service');

export { mcpServerConfigSchema, type MCPServerConfig, type MCPConfig };

export type STDIOServerConfig = Extract<MCPServerConfig, { type: 'stdio' }>;
export type SSEServerConfig = Extract<MCPServerConfig, { type: 'sse' }>;
export type StreamableHTTPServerConfig = Extract<MCPServerConfig, { type: 'streamable-http' }>;
...
export type MCPServerAvailable = ClientMCPServerAvailable & {
  client: MCPClient;
};

export type MCPServerUnavailable = ClientMCPServerUnavailable & {
  client: MCPClient | null;
};

export type MCPServerConnecting = ClientMCPServerConnecting;

          ...
          <TooltipPrimitive.Portal>
            ...
            >
              ...
              <TooltipPrimitive.Arrow
                className={`
                  fill-codinit-elements-background-depth-3
                  ${arrowClassName}
                `}
                width={12}
                height={6}
  ...
  return (
    <TooltipPrimitive.Provider>
      <TooltipPrimitive.Root delayDuration={delayDuration}>
        ...
        >
          {content}
          <TooltipPrimitive.Arrow className="fill-codinit-elements-background-depth-3 dark:fill-codinit-elements-background-depth-4" />
        </TooltipPrimitive.Content>
      </TooltipPrimitive.Root>
    </TooltipPrimitive.Provider>
  );

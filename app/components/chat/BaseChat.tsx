  ...
  (
    ...
    const baseChat = (
      ...
      >
        ...
        <div className="flex flex-col overflow-y-auto w-full h-full md:flex-row">
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow md:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (

      ...
      >
        ...
        <div className="flex flex-col w-full h-full">
          ...
          <div className="flex shrink-0">
            <ClientOnly>{() => <ChatHeader />}</ClientOnly>
          </div>
          {/* Content row */}
          <div className="flex flex-col lg:flex-row overflow-y-auto flex-1 w-full">
              ...
              >
                ...
                >
                  ...
                  <ChatBox
                    ...
                    providerList={
                      providerList || ((PROVIDER_LIST.length > 0 ? PROVIDER_LIST : getProviderList()) as ProviderInfo[])
                    }
                    model={model}
                    setModel={setModel}
                    modelList={modelList}
                    ...
                    setDesignScheme={(_scheme) => {
                      // This will be handled by the store update in ChatBox
                    }}
                  />
                </div>
              </StickToBottom>

          ...
          >
            ...
            <StickToBottom
              className={classNames('pt-6 px-2 sm:px-6 relative h-full', {
                ...
                'flex flex-col items-center justify-center': !chatStarted,
              })}
              resize="smooth"
              initial="smooth"
            >
              <StickToBottom.Content
                className={classNames('gap-4 relative', {
                  ...
                  'flex flex-col items-center justify-center px-2 sm:px-6 h-full': !chatStarted,
                })}
              >
                <ClientOnly>
                  {() => {
              ...
              <div
                className={classNames('flex flex-col gap-2 w-full max-w-chat mx-auto z-prompt mb-6', {
                  ...
                  'items-center justify-center min-h-[60vh]': !chatStarted,
                })}
              >

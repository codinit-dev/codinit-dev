          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="max-w-2xl mx-auto text-center px-4 lg:px-0">
                <h1 className="flex flex-wrap items-center gap-2 text-codinit-elements-textPrimary justify-center font-bold text-5xl tracking-tight mb-6">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stop-color="#1488FC"></stop>
                        <stop offset="1" stop-color="#03305D"></stop>
                      </linearGradient>
                      <linearGradient
                        id="b-light"
                        x1="76.5"
                      ...
                      >
                        ...
                        <stop offset="1" stop-color="#1488FC"></stop>
                      </linearGradient>
                      <linearGradient
                        id="b-dark"
                        x1="76.5"
            ...
            <StickToBottom
              className={classNames('pt-6 px-2 sm:px-6 relative', {
                'h-full flex flex-col modern-scrollbar items-center justify-center': chatStarted,
              })}
              resize="smooth"
              initial="smooth"
            >
              <StickToBottom.Content className="flex flex-col gap-4 relative ">
                <ClientOnly>
                  {() => {
                    return chatStarted ? (
                      <Messages
                        className="flex flex-col w-full max-w-chat pb-4 mx-auto z-1"
                        messages={messages}
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center min-h-[50vh] mt-16">
                  <ChatBox

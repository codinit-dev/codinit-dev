      ...
      >
        <div
          className={classNames(
            ...
            "p-1 rounded-lg text-codinit-elements-item-contentAccent",
            "flex ",
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-codinit-elements-item-backgroundAccent hover:bg-codinit-elements-artifacts-backgroundHover"

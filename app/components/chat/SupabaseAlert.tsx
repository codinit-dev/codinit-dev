  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="max-w-chat rounded-lg border-l-2 border-l-[#098F5F] border border-codinit-elements-borderColor bg-codinit-elements-background-depth-2"
      >
        {/* Header */}
        ...
        <div className="px-4">
          {!isConnected ? (
            <div className="p-3 rounded-md bg-codinit-elements-background-depth-3">
            ...
            <>
              <div
                className="flex items-center p-2 rounded-md bg-codinit-elements-background-depth-3 cursor-pointer"
              ...
              {!isCollapsed && content && (
                <div className="mt-2 p-3 bg-codinit-elements-background-depth-4 rounded-md overflow-auto max-h-60 font-mono text-xs text-codinit-elements-textSecondary">

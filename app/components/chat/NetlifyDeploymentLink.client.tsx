      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-codinit-elements-item-backgroundActive text-codinit-elements-textSecondary hover:text-[#00AD9F] z-50"
            onClick={(e) => {

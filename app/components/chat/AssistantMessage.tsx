...
export const AssistantMessage = memo(
  ({
    ...
    if (
      filteredAnnotations.find(
        (annotation) => annotation.type === "codeContext",
      )
    ) {
      codeContext = filteredAnnotations.find(
        (annotation) => annotation.type === "codeContext",
      )?.files;
    }
                ...
                {chatSummary && (
                  <div className="max-w-chat">
                    <div className="summary max-h-96 flex flex-col">
                      <h2 className="border border-codinit-elements-borderColor rounded-md p4">
                        Summary
                      </h2>
                    ...
                    {codeContext && (
                      <div className="code-context flex flex-col p4 border border-codinit-elements-borderColor rounded-md">
                        <h2>Context</h2>
                        <div
                          className="flex gap-4 mt-4 codinit"
                          style={{ zoom: 0.6 }}
                        >
                          {codeContext.map((x) => {

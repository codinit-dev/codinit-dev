...
export function LockManager() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Controls */}
      <div className="flex items-center gap-1 px-2 py-1 border-b border-codinit-elements-borderColor">
        {/* Search Input */}
        <div className="relative flex-1">
          <span className="absolute left-2 top-1/2 -translate-y-1/2 text-codinit-elements-textTertiary i-ph:magnifying-glass text-xs pointer-events-none" />
          <input
            type="text"
            placeholder="Search..."
            className="w-full text-xs pl-6 pr-2 py-0.5 h-6 bg-codinit-elements-background-depth-2 text-codinit-elements-textPrimary rounded border border-codinit-elements-borderColor focus:outline-none"
            value={searchTerm}
        ...
        {/* Filter Select */}
        <select
          className="text-xs px-1 py-0.5 h-6 bg-codinit-elements-background-depth-2 text-codinit-elements-textPrimary rounded border border-codinit-elements-borderColor focus:outline-none"
          value={filter}
      ...
      <div className="flex items-center justify-between px-2 py-1 text-xs text-codinit-elements-textSecondary">
        <div>
          <Checkbox
            checked={selectAllCheckedState}
            onCheckedChange={handleSelectAll}
            className="w-3 h-3 rounded border-codinit-elements-borderColor mr-2"
        ...
        {selectedItems.size > 0 && (
          <button
            className="ml-auto px-2 py-0.5 rounded bg-codinit-elements-button-secondary-background hover:bg-codinit-elements-button-secondary-backgroundHover text-codinit-elements-button-secondary-text text-xs flex items-center gap-1"
            ...
            {filteredAndSortedItems.map((item) => (
              ...
              >
                <Checkbox
                  ...
                  className="w-3 h-3 rounded border-codinit-elements-borderColor"

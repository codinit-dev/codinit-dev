...
export function getTerminalTheme(overrides?: ITheme): ITheme {
  return {
    ...
    selectionBackground: cssVar(
      "--codinit-elements-terminal-selection-backgroundColor",
    ),
    selectionForeground: cssVar(
      "--codinit-elements-terminal-selection-textColor",
    ),
    selectionInactiveBackground: cssVar(
      "--codinit-elements-terminal-selection-backgroundColorInactive",
    ),

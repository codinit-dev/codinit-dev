...
function ContextMenuItem({
  ...
  return (
    <ContextMenu.Item
      onSelect={onSelect}
      className="flex items-center gap-2 px-2 py-1.5 outline-0 text-sm text-codinit-elements-textPrimary cursor-pointer ws-nowrap text-codinit-elements-item-contentDefault hover:text-codinit-elements-item-contentActive hover:bg-codinit-elements-item-backgroundActive rounded-md"
    >
...
function InlineInput({
  ...
  return (
    <div
      className="flex items-center w-full px-2 bg-codinit-elements-background-depth-4 border border-codinit-elements-item-contentAccent py-0.5 text-codinit-elements-textPrimary"
      style={{ paddingLeft: `${6 + depth * NODE_PADDING_LEFT}px` }}
    >
      <div className="scale-120 shrink-0 i-ph:file-plus text-codinit-elements-textTertiary" />
      <input
        ref={inputRef}
        type="text"
        className="ml-2 flex-1 bg-transparent border-none outline-none py-0.5 text-sm text-codinit-elements-textPrimary placeholder:text-codinit-elements-textTertiary min-w-0"
    ...
    <>
      <ContextMenu.Root>
        ...
        <ContextMenu.Portal>
          <ContextMenu.Content
            style={{ zIndex: 998 }}
            className="border border-codinit-elements-borderColor rounded-md z-context-menu bg-codinit-elements-background-depth-1 dark:bg-codinit-elements-background-depth-2 data-[state=open]:animate-in animate-duration-100 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-98 w-56"
          >
            <ContextMenu.Group className="p-1 border-b-px border-solid border-codinit-elements-borderColor">

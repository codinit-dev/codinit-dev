...
export function Search() {
  ...
  return (
    <div className="flex flex-col h-full bg-codinit-elements-background-depth-2">
      {/* Search Bar */}
      <div className="flex items-center py-3 px-3">
        <div className="relative flex-1">
          <input
            ...
            placeholder="Search"
            className="w-full px-2 py-1 rounded-md bg-codinit-elements-background-depth-3 text-codinit-elements-textPrimary placeholder-codinit-elements-textTertiary focus:outline-none transition-all"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto py-2">
        {isSearching && (
          <div className="flex items-center justify-center h-32 text-codinit-elements-textTertiary">
                    ...
                    return (
                      ...
                      >
                        <pre className="font-mono text-xs text-codinit-elements-textTertiary truncate">
                          ...
                          <span className="bg-codinit-elements-item-backgroundAccent text-codinit-elements-item-contentAccent rounded px-1">

...
export default function NetlifyConnection() {
  ...
  const fetchNetlifyStats = useCallback(async (token: string) => {
            ...
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-codinit-elements-item-contentAccent" />
                  ...
                  <div className="bg-codinit-elements-background dark:bg-codinit-elements-background-depth-1 border border-codinit-elements-borderColor dark:border-codinit-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Button
                        ...
                        className="flex items-center gap-2 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary hover:bg-codinit-elements-item-backgroundActive/10"
                      >
                        <ArrowPathIcon
                          className={classNames(
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <button
                          ...
                          key={site.id}
                          className={classNames(
                            'w-full text-left bg-codinit-elements-background dark:bg-codinit-elements-background-depth-1 border rounded-lg p-4 transition-all cursor-pointer',
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                              <span className="font-medium text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-sm flex items-center gap-1 transition-colors text-codinit-elements-link-text hover:text-codinit-elements-link-textHover dark:text-white dark:hover:text-codinit-elements-link-textHover"
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-codinit-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          ...
                          >
                            ...
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                <span className="text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-codinit-elements-link-text hover:text-codinit-elements-link-textHover dark:text-white dark:hover:text-codinit-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="h-3 w-3 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-codinit-elements-textPrimary dark:text-codinit-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-codinit-elements-item-contentAccent dark:text-codinit-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-codinit-elements-textDestructive dark:text-codinit-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-codinit-elements-textDestructive dark:text-codinit-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-codinit-elements-background dark:bg-codinit-elements-background border border-codinit-elements-borderColor dark:border-codinit-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
        ...
        {!connection.user ? (
          <div className="mt-4">
            <label
              ...
              className="block text-sm text-codinit-elements-textSecondary dark:text-codinit-elements-textSecondary mb-2"
            >
              API Token
            </label>
            <input

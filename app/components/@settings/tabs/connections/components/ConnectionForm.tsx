      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-codinit-elements-textPrimary">Connection Settings</h3>
              <p className="text-sm text-codinit-elements-textSecondary">Configure your GitHub connection</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={onSave} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-sm font-medium text-codinit-elements-textSecondary mb-2">
              GitHub Username
            </label>
            <input
              id="username"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label htmlFor="token" className="block text-sm font-medium text-codinit-elements-textSecondary">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[#E5E5E5] dark:border-[#1A1A1A]">
            ...
            {authState.rateLimits && (
              <div className="flex items-center gap-2 text-sm text-codinit-elements-textTertiary">

...
export function ConnectionForm({
  ...
  useEffect(() => {
    const savedToken =
      Cookies.get(GITHUB_TOKEN_KEY) ||
      Cookies.get("githubToken") ||
      getLocalStorage(GITHUB_TOKEN_KEY);
        ...
        <form onSubmit={onSave} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label
                htmlFor="token"
                className="block text-sm font-medium text-codinit-elements-textSecondary"
              >
            ...
            {authState.rateLimits && (
              <div className="flex items-center gap-2 text-sm text-codinit-elements-textTertiary">
                ...
                <span>
                  ...
                  {authState.rateLimits.reset.toLocaleTimeString()}
                </span>
              </div>
            )}
          </div>

  ...
  async checkStatus(): Promise<StatusCheckResult> {
    try {
      ...
      const services = {
        api: {
          operational:
            text.includes("API Service") && text.includes("Operational"),
          degraded:
            text.includes("API Service") &&
            text.includes("Degraded Performance"),
          outage:
            text.includes("API Service") && text.includes("Service Outage"),
        },
        routing: {
          operational:
            text.includes("Routing Service") && text.includes("Operational"),
          degraded:
            text.includes("Routing Service") &&
            text.includes("Degraded Performance"),
          outage:
            text.includes("Routing Service") && text.includes("Service Outage"),
        },
      };

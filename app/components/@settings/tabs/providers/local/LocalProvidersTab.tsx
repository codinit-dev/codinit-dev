  ...
  const ModelDetails = ({ model }: { model: OllamaModel }) => (
    <div className="flex items-center gap-3 text-xs text-codinit-elements-textSecondary">
      ...
      {model.details && (
        <>
          <div className="flex items-center gap-1">
            <div className="i-ph:database text-blue-500" />
            <span>{model.details.parameter_size}</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="i-ph:cube text-blue-500" />
                ...
                <div className="flex items-start gap-4">
                  <motion.div
                    className={classNames(
                      ...
                      provider.settings.enabled ? 'text-blue-500' : 'text-codinit-elements-textSecondary',
                    )}
                      ...
                      {editingProvider === provider.name ? (
                        ...
                        <div
                          ...
                          className={classNames(
                            ...
                            'bg-codinit-elements-background-depth-3 border border-codinit-elements-borderColor',
                            'hover:border-blue-500/30 hover:bg-codinit-elements-background-depth-4',
                            'transition-all duration-200',
                          )}
                        >
              ...
              {provider.settings.enabled && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="i-ph:cube-duotone text-blue-500" />
                      ...
                      <div className="text-center py-8 text-codinit-elements-textSecondary">
                        ...
                        <p className="text-sm text-codinit-elements-textTertiary px-1">
                          ...
                          <a
                            ...
                            className="text-blue-500 hover:underline inline-flex items-center gap-0.5 text-base font-medium"
                          >
                            ollama.com/library

...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  >([]);
  const [averageMessagesPerChat, setAverageMessagesPerChat] =
    useState<number>(0);
  ...
  useEffect(() => {
    ...
    const sortedDates = Object.keys(chatDates).sort(
      ...
      datasets: [
        {
          ...
          backgroundColor: Object.keys(messagesByRole).map(
            (_, i) => getChartColors(i).bg,
          ),
          borderColor: Object.keys(messagesByRole).map(
            (_, i) => getChartColors(i).border,
          ),
          borderWidth: 1,
        },
      ],
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-codinit-elements-textSecondary">
          Start creating chats to see your usage statistics and data
          visualization.
        </p>
      </div>
    );
  ...
  const statClasses = classNames(
    "text-3xl font-bold text-codinit-elements-textPrimary",
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-codinit-elements-textPrimary mb-4">
            Total Chats
          </h3>
        ...
        <div className={cardClasses}>
          ...
          <div className={statClasses}>
            ...
            <span>
              {Object.values(messagesByRole).reduce(
                (sum, count) => sum + count,
                0,
              )}
            </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-codinit-elements-textPrimary mb-6">
            Chat History
          </h3>
          <div className="h-64">

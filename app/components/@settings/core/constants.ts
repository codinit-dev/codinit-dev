...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'agent', visible: true, window: 'user' as const, order: 1 },
  ...
  { id: 'update', visible: true, window: 'user' as const, order: 13 },

  // Developer Window Tabs (All visible by default)
  { id: 'features', visible: true, window: 'developer' as const, order: 0 },
  { id: 'agent', visible: true, window: 'developer' as const, order: 1 },

...
export async function getLocalStarter(userPrompt?: string) {
  // Load files from local codinit-vite-starter directory
  const files: Array<{ name: string; path: string; content: string }> = [
    {
      name: 'prompt',
      path: '.codinit-dev/prompt',
      content: `# Prompt

Make every design beautiful, unique, and not cookie-cutter.

By default, this template supports JSX syntax with Tailwind CSS classes, the shadcn/ui library, React hooks, and Lucide React for icons. Do not install other packages for UI themes, icons, etc unless absolutely necessary or I request them.

Use icons from lucide-react for logos.

Webpages should be fully featured, responsive, and production-ready.

Use TSX, Tailwind CSS, shadcn/ui, React hooks, and Lucide React icons by default.

Don't add extra UI libraries or icon packs unless I ask for them or they're absolutely necessary.

Icons and logos should come from Lucide React.

Aim for clean, modern, and polished results every time.

DO NOT REMOVE ANYTHING FROM THE PACKAGE.JSON ONLY ADD TO IT`,
    },
    {
      name: '.gitignore',
      path: '.gitignore',
...
<html lang="en">
  <head>
    ...
    <title>codinit-vite-starter</title>
  </head>
  <body>
    <div id="root"></div>
...
`,
    },
    {
      ...
      content: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--logos" width="35.93" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 228"><path fill="#00D8FF" d="M210.483 73.824a171.49 171.49 0 0 0-8.24-2.597c.465-1.9.893-3.777 1.273-5.621c6.238-30.281 2.16-54.676-11.769-62.708c-13.355-7.7-35.196.329-57.254 19.526a171.23 171.23 0 0 0-6.375 5.848a155.866 155.866 0 0 0-4.241-3.917C100.759 3.829 77.587-4.822 63.673 3.233C50.33 10.957 46.379 33.89 51.995 62.588a170.974 170.974 0 0 0 1.892 8.48c-3.28.932-6.445 1.924-9.474 2.98C17.309 83.498 0 98.307 0 113.668c0 15.865 18.582 31.778 46.812 41.427a145.52 145.52 0 0 0 6.921 2.165a167.467 167.467 0 0 0-2.01 9.138c-5.354 28.2-1.173 50.591 12.134 58.266c13.744 7.926 36.812-.22 59.273-19.855a145.567 145.567 0 0 0 5.342-4.923a168.064 168.064 0 0 0 6.92 6.314c21.758 18.722 43.246 26.282 56.54 18.586c13.731-7.949 18.194-32.003 12.4-61.268a145.016 145.016 0 0 0-1.535-6.842c1.62-.48 3.21-.974 4.76-1.488c29.348-9.723 48.443-25.443 48.443-41.52c0-15.417-17.868-30.326-45.517-39.844Zm-6.365 70.984c-1.4.463-2.836.91-4.3 1.345c-3.24-10.257-7.612-21.163-12.963-32.432c5.106-11 9.31-21.767 12.459-31.957c2.619.758 5.16 1.557 7.61 2.4c23.69 8.156 38.14 20.213 38.14 29.504c0 9.896-15.606 22.743-40.946 31.14Zm-10.514 20.834c2.562 12.94 2.927 24.64 1.23 33.787c-1.524 8.219-4.59 13.698-8.382 15.893c-8.067 4.67-25.32-1.4-43.927-17.412a156.726 156.726 0 0 1-6.437-5.87c7.214-7.889 14.423-17.06 21.459-27.246c12.376-1.098 24.068-2.894 34.671-5.345a134.17 134.17 0 0 1 1.386 6.193ZM87.276 214.515c-7.882 2.783-14.16 2.863-17.955.675c-8.075-4.657-11.432-22.636-6.853-46.752a156.923 156.923 0 0 1 1.869-8.499c10.486 2.32 22.093 3.988 34.498 4.994c7.084 9.967 14.501 19.128 21.976 27.15a134.668 134.668 0 0 1-4.877 4.492c-9.933 8.682-19.886 14.842-28.658 17.94ZM50.35 144.747c-12.483-4.267-22.792-9.812-29.858-15.863c-6.35-5.437-9.555-10.836-9.555-15.216c0-9.322 13.897-21.212 38.14-29.504c2.558-.758 5.11-1.557 7.64-2.389c3.256 10.118 7.653 20.885 13.047 32.063c-5.354 11.267-9.796 22.093-13.414 32.909Zm25.508 49.06a134.21 134.21 0 0 1-1.388-6.182c-10.632-2.457-22.338-4.255-34.736-5.36c-7.117-9.988-14.439-19.17-21.866-27.23a156.36 156.36 0 0 1 6.437 5.867c18.611 16.005 35.864 22.074 43.931 17.404c3.792-2.195 7.058-7.674 8.582-15.893c1.697-9.147 1.332-20.847-1.23-33.787l-.73 4.211Zm40.966-95.686c-12.482 4.265-22.793 9.812-29.859 15.863c-6.35 5.437-9.555 10.836-9.555 15.216c0 9.322 13.897 21.212 38.14 29.504c2.558.758 5.11 1.557 7.64 2.389c3.256-10.118 7.653-20.885 13.047-32.063c-5.354-11.267-9.796-22.093-13.413-32.909Zm25.507-49.06a134.21 134.21 0 0 1 1.388 6.182c10.632 2.457 22.338 4.255 34.736 5.36c7.117 9.988 14.439 19.17 21.866 27.23a156.36 156.36 0 0 1-6.437-5.867c-18.611-16.005-35.864-22.074-43.931-17.404c-3.792 2.195-7.058 7.674-8.582 15.893c-1.697 9.147-1.332 20.847 1.23 33.787l.73-4.211Z"></path></svg>`,
    },
  ];

  const filteredFiles = files.filter((x) => !x.path.startsWith('.git'));

  const assistantMessage = `
CodinIT is initializing your project with the required files using the codinit-vite-starter template.
<exampleArtifact id="imported-files" title="Create initial files" type="bundled">
${filteredFiles
  .map(
    (file) =>
...
`;
  ...
  let userMessage = ``;
  const templatePromptFile = files.find((x) => x.path === '.codinit-dev/prompt');
...
---
Now that the Template is imported please continue with my original request: ${userPrompt || 'Build something amazing'}

...
Deploy the app to CodinIT and start the Vite development server (if not already running).
...
apis may be being used. Isolating those dependencies into a codinit file of only actions

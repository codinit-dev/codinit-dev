import { setCodinitDebugProperty } from './codinitDebug.js';
...
export function codinitSetLogLevel(level: DebugLevel) {
...
if (typeof window !== 'undefined') {
  ...
  setCodinitDebugProperty('setLogLevel', codinitSetLogLevel);
}
